...
# ============================================
alpha_values_miqp = [1,2,4,6]   # Valores de cardinalidade usados
...
# ============================================
# MIQP PONDERADO via CPLEX/DOcplex
# Informações sobre o código abaixo são encontradas no trabalho escrito.
# ============================================
...
for alpha in alpha_values_miqp:
    ...
    plt.scatter(arr[:,0], arr[:,1], marker='s', facecolors='none',edgecolors=colors[alpha],s=80, linewidths=1.5, label=f'MIQP α$=${alpha}')
