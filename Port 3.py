...
Original file is located at
    https://colab.research.google.com/drive/1d0cxe5vKt2ruh5T7xHMCpBmY1zhoqLPa
"""



# ================================
# Código 23/06 - AL-Quad - PORT 3
...
# ===============================================================
url = 'https://people.brunel.ac.uk/~mastjjb/jeb/orlib/files/port3.txt'
...
# ==================================================
# MÉTODO DE DYKSTRA
# Transcrito para python do trabalho de Krejic (2024)
# ==================================================
...
# ====================================================
n_starts     = 30
alpha_values = [1,2,3,4,5,6,7,8,10,15,20,25,30,35,40,45,50,55,60,65,70,75,80,85,89]
...
alpha_values_miqp = [1,2,3,4,5,6,7,8,10,15,20,25,30,35,40,45,50,55,60,65,70,75,80,85,89]
...
def solve_weighted(alpha, lam):
    ...
    mdl.parameters.timelimit = 120 #CPLEX encerra a busca quando atinge 120s, mesmo que não tenha provado otimalidade
    t0 = time.time()
...
# Tabela Pareto MIQP não dominada
...
# ============================================================================================
# (NÃO USADO NA PRÁTICA-Tudo no notebook de perfis de desempenho)
#  Loop sobre cada α para calcular /HV vs kappa/ Delta - spread/ T_MIN (Não usado na prática)
# ============================================================================================
# Constroi novamente ND_orig: não-dominados do problema original
#ND_orig = {}
#for α in alpha_values:
    # calcula todos os objetivos originais (f1,f2) = (half_var, -retorno)
...
# ===============================================================
# Leitura dos dados do problema Port 3 de OR-LIB
# ===============================================================
# O site indicado contém o arquivo port2.txt com a seguinte estrutura:
#      linha 0  – número de ativos (n)
#      linhas 1..n  – retorno médio e desvio padrão de cada ativo
